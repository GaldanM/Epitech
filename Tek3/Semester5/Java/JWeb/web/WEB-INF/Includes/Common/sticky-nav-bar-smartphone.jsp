    ...
    <div class="container-fluid">
        ...
        <div>
            <ul class="nav navbar-nav">
                ...
                <li class="li-niv-3 sticky-li-smartphone"><a href="#" class="car-btn-bar">Caracteristics</a></li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <button type="button" class="btn btn-primary btn-lg btn-smartphone-buy" data-toggle="modal" data-target="#myModal">
