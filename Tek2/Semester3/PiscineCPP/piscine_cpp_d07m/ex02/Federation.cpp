...
// Last update Wed Jan 14 00:19:51 2015 Galdan MOULINNEUF
//
...
Federation::Starfleet::Ship::Ship(int length, int width, std::string name, short maxWarp, Destination home)
{
  this->_home = home;
...
Federation::Ship::Ship(int length, int width, std::string name, short maxWarp, Destination home)
{
  this->_home = home;
  this->_location = this->_home;
  this->_length = length;
