...
// Last update Thu Jan 15 09:16:14 2015 Galdan MOULINNEUF
//
...
{
  if (&to_comp)
    if(to_comp._ID == _ID && to_comp._Energy == _Energy && to_comp._Attack == _Attack && to_comp._Toughness == _Toughness && to_comp._Status == _Status)
      return (true);
  return (false);
}
